...
<div class="rts-banner-area-one bg_image--1 bg_image rts-section-gap">
            ...
            <div class="col-lg-12">
                <div class="content-main-wrapper">
                    ...
                    <div class="button-area">
                        <a href="log-in.html" class="rts-btn btn-primary">Try OpenUp Free</a>
                        <a href="contact.html" class="rts-btn btn-blur">Request demo</a>
                    </div>
                    <div class="user-area">
                        <p>10,000+ People make by OpenUp</p>
                        <div class="image-wrapper">
                            <img class="one" src="{{asset("font/assets/images/banner/user/01.png")}}" alt="user" loading="lazy">
                            <img class="two" src="{{asset("font/assets/images/banner/user/02.png")}}" alt="user" loading="lazy">
                            <img class="three" src="{{asset("font/assets/images/banner/user/04.png")}}" alt="user" loading="lazy">
                            <img class="four" src="{{asset("font/assets/images/banner/user/03.png")}}" alt="user" loading="lazy">
                            <img class="five" src="{{asset("font/assets/images/banner/user/05.png")}}" alt="user" loading="lazy">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="bottom-mid-img">
        <img src="{{asset("font/assets/images/banner/01.png")}}" alt="banenr mimage" loading="lazy">
    </div>
    <div class="usefull-for-ani">
        <div class="single">
            <img src="{{asset("font/assets/images/banner/user/06.png")}}" alt="img" loading="lazy">
            <span>Content Writer</span>
        </div>
        <div class="single blog">
            <img src="{{asset("font/assets/images/banner/user/05.png")}}" alt="img" loading="lazy">
            <span>Blog Writer</span>
        </div>
        <div class="single copy">
            <img src="{{asset("font/assets/images/banner/user/03.png")}}" alt="img" loading="lazy">
            <span>Copy Writer</span>
        </div>
        <div class="single freelancer">
            <img src="{{asset("font/assets/images/banner/user/04.png")}}" alt="img" loading="lazy">
        ...
        <div class="row mt--50">
            <div class="col-lg-12">
                <div class="brand-area-main-wrapper-one">
                    <img src="{{asset("font/assets/images/brand/01.png")}}" alt="brand" loading="lazy">
                    <img src="{{asset("font/assets/images/brand/02.png")}}" alt="brand" loading="lazy">
                    <img src="{{asset("font/assets/images/brand/03.png")}}" alt="brand" loading="lazy">
                    <img src="{{asset("font/assets/images/brand/04.png")}}" alt="brand" loading="lazy">
                    <img src="{{asset("font/assets/images/brand/05.png")}}" alt="brand" loading="lazy">
                    <img src="{{asset("font/assets/images/brand/06.png")}}" alt="brand" loading="lazy">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="single-feature-area-start index-feature">
                    <div class="image-area">
                        <img src="{{asset("font/assets/images/feature/07.svg")}}" alt="feature_image" loading="lazy">
                    </div>
                    <div class="featue-content-area">
                        ...
                        <a href="contact.html" class="rts-btn btn-primary">Get Started Free</a>
                    </div>
                </div>
                ...
                <div class="single-feature-area-start index-feature bg-red-l">
                    ...
                    <div class="image-area">
                        <img src="{{asset("font/assets/images/feature/08.svg")}}" alt="feature_image" loading="lazy">
                    </div>
                </div>
                <!-- single openup feature area end -->
                <!-- single openup feature area start -->
                <div class="single-feature-area-start index-feature bg-blue-l">
                    <div class="image-area">
                        <img src="{{asset("font/assets/images/feature/09.svg")}}" alt="feature_image" loading="lazy">
                    </div>
                    <div class="featue-content-area">
        ...
        <div class="row mt--25 g-5">
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                ...
                <div class="single-tools-feature">
                    ...
                    <a href="use-case.html" class="rts-btn btn-lonly">Try Blog Content <i class="fa-regular fa-arrow-right"></i></a>
                </div>
                <!-- sngle tools featuer -->
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                ...
                <div class="single-tools-feature">
                    ...
                    <a href="use-case.html" class="rts-btn btn-lonly">Try Social Content <i class="fa-regular fa-arrow-right"></i></a>
                </div>
                <!-- sngle tools featuer -->
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                ...
                <div class="single-tools-feature">
                    ...
                    <a href="use-case.html" class="rts-btn btn-lonly">Try eCommerce Copy<i class="fa-regular fa-arrow-right"></i></a>
                </div>
                <!-- sngle tools featuer -->
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                ...
                <div class="single-tools-feature">
                    ...
                    <a href="use-case.html" class="rts-btn btn-lonly">Try Sales Copy<i class="fa-regular fa-arrow-right"></i></a>
                </div>
                <!-- sngle tools featuer -->
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                ...
                <div class="single-tools-feature">
                    ...
                    <a href="use-case.html" class="rts-btn btn-lonly">Try Website Copy<i class="fa-regular fa-arrow-right"></i></a>
                </div>
                <!-- sngle tools featuer -->
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
...
{{--                <img src="{{asset("font/assets/images/cta/03.png")}}" alt="cta-wrapper" loading="lazy">--}}
{{--            </li>--}}
{{--        </ul>--}}
            ...
            <div class="col-lg-12">
                <div class="cta-main-wrapper bg_image">
                    <div class="left">
                        ...
                        <a href="about.html" class="rts-btn btn-primary">Get Started Now</a>
                    </div>
                    <div class="right">
